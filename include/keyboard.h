...
#define	KB_IN_BYTES	32//size of kyboard input buffer
#define MAP_COLS 3//number of columns in keymap
#define NR_SCAN_CODES 0x80//number of rows in keymap

//key board special keys:
...
struct kb_inbuf {
	char*	p_head;//to the next free position of buffer
	char*	p_tail;//to the next position where keyboard handling
